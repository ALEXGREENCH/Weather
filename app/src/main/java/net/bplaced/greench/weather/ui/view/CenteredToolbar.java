package net.bplaced.greench.weather.ui.view;
...
public class CenteredToolbar extends Toolbar {
    ...
    private TextView getCenteredTitleTextView() {
        if (centeredTitleTextView == null) {
            ...
            //Typeface typeface = ResourcesCompat.getFont(getContext(), R.font.press_start_2p);
            //centeredTitleTextView.setTypeface(typeface);
